...
async function createOrder(userId, orderItems) {
    ...
    try {
        // we will need a transaction when a process involves inserting or updating or deleting
        // two more more tables
        ...
        // finalize the changes made to the tables in a transaction
        await connection.commit();
        return orderId;
    } catch (error) {
        // if there's an error, rollback will restore the database
        // to its initial state before any changes were made
